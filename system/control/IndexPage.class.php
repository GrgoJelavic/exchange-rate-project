...
class IndexPage extends AbstractPage
{
    ...
    public function code()
    {
        ...
        6) Rate by period: <br> localhost/exchange-rate-project/index.php?page=PeriodHistory&fromDate=2021-06-11&toDate=2021-06-14&code=EUR<br><br><br>
        <b>III. Currency exchange:</b> <br><br> 
        7) Exchange: <br> localhost/exchange-rate-project/index.php?page=CurrencyConverter&from=USD&to=HRK&amount=100
        <br>
        ';
    }
}
